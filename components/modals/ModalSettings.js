...
export function ModalSettings (props) {
    ...
    ///////////////// constants datas //////////////////////////////////
    const settingsInputAngle = useMemo(() => ([
        {
            id: 0, 
            label: languages[0][props.idLanguage].input_number,
            value: '0',
            color: "white",
            layout: "row",
            size: 15,
        ...
        {
            id: 1,
            label:  languages[0][props.idLanguage].input_slider,
            value: '1',
            color: "white",
            layout: "row",
            size: 15,
    ...
    ]), [languages[0][props.idLanguage].input_number, languages[0][props.idLanguage].input_slider]);
    ...
    return  (
        <View style={[ {justifyContent: "center", alignItems: "center"} ]}>
            <Modal style={[ {justifyContent: "center", alignItems: "center"} ]} animationType={"fade"} transparent={true} visible={props.statusModalSettings}>
                <Pressable style={[ {width: width, justifyContent: 'space-between', alignSelf: "center", alignItems: 'center', opacity: (height > 650 ? 0.9 : 0.97), backgroundColor : "#151515"} ]} onPress={ props.makeStatusModalSettings }>
                    <Pressable style={[ {width: (width*0.9), height: height*0.7, marginTop: height*0.05, paddingBottom: height*0.1, justifyContent: 'space-between', alignSelf: "center", alignItems: 'center', borderRadius: 5, backgroundColor : "#3b3b3b"} ]} onTouchEnd={ (e) => e.stopPropagation() }>
                        ...
                        <View style={[ {flexDirection: "column", backgroundColor: "transparent"} ]}>
                            <Text style={[ {marginBottom: 2.5, justifyContent: "center", fontSize: height*0.015, fontWeight: "bold", letterSpacing: 0.5, textAlign: "center", color: "aqua"} ]}>{`${languages[0][props.idLanguage].unit_measure}`}</Text>
                            ...
                            <View style={[ {marginBottom: width*0.05, justifyContent: "center", alignItems: "center"} ]}>
                                <Text style={[ {marginBottom: 2.5, justifyContent: "center", fontSize: height*0.015, fontWeight: "bold", letterSpacing: 0.5, textAlign: "center", color: "aqua"} ]}>{`${languages[0][props.idLanguage].angle_base}`}</Text>
                            ...
                            <View style={[ {marginBottom: width*0.05, justifyContent: "center", alignItems: "center"} ]}>
                                <Text style={[ {marginBottom: 2.5, justifyContent: "center", fontSize: height*0.015, fontWeight: "bold", textAlign: "center", letterSpacing: 0.5, color: "aqua"} ]}>{`${languages[0][props.idLanguage].datas_base}`}</Text>
                            ...
                            <View style={[ {marginBottom: width*0.025, justifyContent: "center", alignItems: "center"} ]}>
                                <Text style={[ {marginBottom: 2.5, justifyContent: "center", fontSize: height*0.015, fontWeight: "bold", letterSpacing: 0.5, textAlign: "center", color: "aqua"} ]}>{`${languages[0][props.idLanguage].choice_diameter_control}`}</Text>

                                <SafeAreaView style={[ {width: width*0.85, paddingLeft: width*0.07, flexDirection: "row", justifyContent: "flex-start", borderRadius: 25, backgroundColor: "gray"} ]}>
                                    <RadioGroup layout={"row"} radioButtons={settingsInputAngle} selectedId={props.idCurrentDiameterForSlider} onPress={props.setIdCurrentDiameterForSlider} />                        
                                </SafeAreaView>
                            </View>

                            <View style={[ {marginBottom: width*0.025, flexDirection: "column", justifyContent: "center"} ]}>
                                <Text style={[ {marginBottom: 5, justifyContent: "center", fontSize: height*0.015, fontWeight: "bold", letterSpacing: 0.5, textAlign: "center", color: "aqua"} ]}>{`${languages[0][props.idLanguage].values} - ${languages[0][props.idLanguage].interface}`}</Text>
                        ...
                        <Pressable style={[ { height: height*0.005, marginBlockStart: height*0.03, justifyContent: "center", alignItems: "center" } ]} onPress={ () => { props.makeStatusModalSettings(); } }>
