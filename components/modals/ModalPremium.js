        ...
        <View style={[ {justifyContent: "center", alignItems: "center"} ]}>
            <Modal style={[ {justifyContent: "center", alignItems: "center"} ]} animationType={"slide"} transparent={true} visible={props.statusModalPremium}>
                <Pressable style={[ {width: width, backgroundColor: "transparent"} ]} onPress={ props.makeStatusModalPremium }>
                    <Pressable style={[ {width: width, height: height*0.95, marginTop: (height*0.05), justifyContent: 'space-between', alignSelf: "center", alignItems: 'flex-end', opacity: 0.975, backgroundColor : "#151515"} ]} onTouchEnd={ (e) => { e.stopPropagation() } }>
                        ...
                        <View style={[ {width: width, height: Number(height*0.9), flexDirection: "column", justifyContent: "flex-start", alignItems: "center", backgroundColor: "transparent"} ]}>
                            ...
                            <View style={[ { flexDirection: "column", marginTop: height*0.015, justifyContent: "flex-start", alignItems: "center", backgroundColor: "transparent"} ]}>                                 
                                <View style={[ {flexDirection: "row", justifyContent: "flex-start", alignItems: "flex-start", backgroundColor: "transparent"} ]}> 
                                    <View style={[ {width: width/2.95, maxHeight: height*0.33, flexDirection: "column", justifyContent: "center", alignItems: "center", backgroundColor: "transparent"} ]}> 
                                        <Pressable style={[ styles.menuBox, { backgroundColor: "forestgreen" } ]} onPress={ () => { return false; } }>
                            ...
                            <View style={[ { height: height*0.24, flexDirection: "column", justifyContent: "flex-end", alignItems: "center", backgroundColor: "transparent"} ]}>                                 
                                <View style={{ alignItems: "center" }}>                                    
                                    <Pressable style={{ width: width * 0.75, justifyContent: "center", alignSelf: "center", alignItems: "center", borderWidth: 2.5, borderColor: "silver", borderRadius: 25, backgroundColor: 'green' }} onPress={() => Linking.openURL('https://play.google.com/store/apps/details?id=com.production.pipingdata&hl=fr')}>
                                        <Text style={{ width: width * 0.75, marginVertical: height * 0.015, lineHeight: width * 0.05, fontSize: width * 0.05, fontWeight: "bold", textAlign: "center", letterSpacing: 1.5, color: "white" }}>{`${functions.firstLetterToUpperCase(languages[0][props.idLanguage].pro)} 2,29 €`}</Text>
                                    </Pressable>
                                </View>
                                ...
                                <Pressable style={[ { justifyContent: "center", alignSelf: "center", alignItems: "center", borderTopWidth: (height*0.01), borderBottomWidth: (height*0.05), borderColor: "transparent", } ]} onPress={ () => { props.makeStatusModalPremiumOnModalPremium(); } }>
                                    <Text style={[ { width: Number(width*0.45), lineHeight: Number(height*0.06), fontSize: Number(height*0.02), textAlign: "center", letterSpacing: 0.5, color: "white", borderRadius: 25, backgroundColor: '#3498db' } ]}>{languages[0][props.idLanguage].later}</Text>
                                </Pressable>
                            </View>
                        </View>
                    </Pressable> 
